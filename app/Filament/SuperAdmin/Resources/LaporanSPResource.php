...
use App\Filament\SuperAdmin\Resources\LaporanSPResource\Pages;
...
class LaporanSPResource extends Resource
{
    ...
    public static function table(Table $table): Table
{
    ...
    {
        return [
            'index' => Pages\ListLaporanSPS::route('/'),
            'create' => Pages\CreateLaporanSP::route('/create'),
            'edit' => Pages\EditLaporanSP::route('/{record}/edit'),
        ];
    }
